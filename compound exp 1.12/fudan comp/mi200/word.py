...
if __name__=='__main__':
    ...
    DataAnalysis().writeMatrix([["复旦计算机","句子数量",len(data),"方法","mi","support","10","阈值","200"],
    	["复合词","复合词","复合词数量","词1数量","词2数量","方法算出值"]], "result.txt")
    #mi
    resultList = DataAnalysis().MiMethodRe(data, threshold1=10, threshold2=200)
    #mc
    #resultList = DataAnalysis().McMethodRe(data, threshold1=20, threshold2=0.8)
    #confidenceLevel
