...
if __name__=='__main__':
    ...
    DataAnalysis().writeMatrix([["复旦计算机","句子数量",len(data),"方法","confidence","support","10","阈值","0.4"],
...
#confidenceLevel
    resultList = DataAnalysis().confidenceLevelMethodRe(data, threshold1=10, threshold2=0.4)
    #print resultList
#dmc
	#resultList = DataAnalysis().McMethodRe(data, threshold1=10, threshold2=0.4)
#support
